...
try {
  await page.goto(`${BASE}/manga/${TEST_MANGA}/chapter/${TEST_CHAPTER}`, { waitUntil: "networkidle", timeout: 30000 });
...
try {
  await page.goto(`${BASE}/manga/${EXT_MANGA}/chapter/${EXT_CHAPTER}`, { waitUntil: "networkidle", timeout: 20000 });
